...
const ExtensionBar = () => {
  ...
  return (
    <div className="flex justify-between max-w-7xl mx-auto max-[375px]:mx-3 max-[375px]:px-3 lg:px-3 py-3 shadow-md bg-neutral-0 dark:bg-neutral-800 rounded-2xl">
